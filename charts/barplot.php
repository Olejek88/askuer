...
for ($l=1;$l<=1000;$l++)
    {
     ...
     if ($uy == true)
        {
         if ($arr["source"]==1 && strstr ($uy[1],'‎םונדטט')) for ($o=0;$o<=$max; $o++) if (strstr($date1[$o],$uy[3])) $data0[$o]=$data0[$o]+$uy[7];
         if ($arr["source"]==2) if (strstr ($uy[1],'בתול')) for ($o=0;$o<=$max; $o++) if (strstr($date1[$o],$uy[3])) $data0[$o]=$data0[$o]+$uy[7];
         if ($arr["source"]==3) for ($o=0;$o<=$max; $o++) if (strstr($date1[$o],$uy[3])) $data0[$o]=$data0[$o]+$uy[7];
         if ($arr["source"]==4 && strstr ($uy[1],'מבתולא')) for ($o=0;$o<=$max; $o++) if (strstr($date1[$o],$uy[3])) $data0[$o]=$data0[$o]+$uy[7];
         if ($arr["source"]==5 && strstr ($uy[1],'מבתולא')) for ($o=0;$o<=$max; $o++) if (strstr($date1[$o],$uy[3])) $data0[$o]=$data0[$o]+$uy[7];
         if ($arr["source"]==6 && strstr ($uy[1],'מבתולא')) for ($o=0;$o<=$max; $o++) if (strstr($date1[$o],$uy[3])) $data0[$o]=$data0[$o]+$uy[7];
         if ($arr["source"]==7) for ($o=0;$o<=$max; $o++) if (strstr($date1[$o],$uy[3])) $data0[$o]=$data0[$o]+$uy[7];
        }
    }
