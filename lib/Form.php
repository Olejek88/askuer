...
if (!defined('HTML_FORM_TEXTAREA_HT')) {
    define('HTML_FORM_TEXTAREA_HT', 7);
}
...
if (!defined('TEXT_MAX_LENGHT')) {
    define('TEXT_MAX_LENGHT', 45); // 1 MB
}
...
class HTML_Form {
    ...
    function HTML_Form($action, $method = 'GET', $name = '', $target = '',$onsubmit='') {
                $this->action = $action;
                $this->method = $method;
                $this->name = $name;
                $this->fields = array();
    ...
    function displayText($name, $default = '', $size = HTML_FORM_TEXT_SIZE) {
        print "<INPUT NAME=\"$name\" VALUE=\"$default\" SIZE=\"$size\"  maxlength='".TEXT_MAX_LENGHT."'>";
    }
    ...
    function displayPasswordRow($name, $title, $default = '', $size = HTML_FORM_PASSWD_SIZE) {
        ...
        print " <font style='font:bold 12;'>повторите:</font> ";
    ...
    function displayTextarea($name, $default = '', $width = 50, $height = 5) {
        print "<TEXTAREA NAME=\"$name\" COLS=\"$width\" ROWS=\"$height\" maxlength='TEXT_AREA_MAX_LENGHT'>";
        print $default;
        print "</TEXTAREA>";
    }
    ...
    function displayTextareaRow($name, $title, $default = '', $width = 50, $height = 5) {
        print " <TR>\n";
        print "  <TH ALIGN=\"right\">$title</TH>\n";
        print "  <TD>";
