...
print '<b>Исходные данные</b><br>';
print 'Арендаторов: '; print $arend_num; print '<br>';
print 'Корпусов: '; print $korp_num; print '<br>';
print 'Энергоресурсов: '; print $energy_num; print '<br>';
print 'Объектов: '; print $object_num; print '<br>';
//--------------------------------------------------------------------	
...
//	}
//}
//print 'Температура зимой: '; print $rs_temp; print '<br>';
//print 'Продолжительность отопительного периода: '; print $cold; print '<br>';
//print '<hr>';
//-------------------------------------------------------
$query = 'SELECT * FROM energy_supply';
 ...
 if ($ui == true) 
	{        
	 ...
	 if ($ui[2]=='1')	// тепло и теплофикационная вода
		{
		 ...
		 print 'Общее потребление тепла: <b>'; print $QT; print '</b>';
		 //-------------------------------------------------------
		 ...
		 for ($c=1;$c<=100;$c++)
			{
			 ...
			 if ($up == true)
			     ...
			     for ($x=1;$x<=12000;$x++)
				{
			     ...
			     print '<br>Общее потребление по <b>'; print $up[2]; print '</b>: '; print $QTkor;
	 ...
	 if ($ui[2]=='2')	// пожарно-питьевая вода
		{
		 print '<br><h2>пожарно-питьевая вода: </h2>';
		 ...
		 print 'Общее потребление воды: '; print $QV;
		 //-------------------------------------------------------		 
		 ...
		 for ($c=1;$c<=100;$c++)
			{
			 ...
			 if ($up == true)
			     ...
			     for ($x=1;$x<=12000;$x++)
				{
			     ...
			     print '<br>Общее потребление по <b>'; print $up[2]; print '</b>: '; print $QVkor;
	 ...
	 if ($ui[2]=='3' || $ui[2]=='4' || $ui[2]=='5' || $ui[2]=='6')	// пар, воздух, газ и кислород
		{
		 print '<br><h2>Пар, воздух, газ и кислород: </h2>';
		 $res=$ui[2];
		 ...
		 if ($res==3) { print '<br>Общее потребление пара: '; print $QP; }
		 if ($res==4) { print '<br>Общее потребление газа: '; print $QP; }
		 if ($res==5) { print '<br>Общее потребление воздуха: '; print $QP; }
		 if ($res==6) { print '<br>Общее потребление кислорода: '; print $QP; }
		 //-------------------------------------------------------		 
			 ...
			 if ($up == true)
			    {
			     ...
			     print '<br>Общее потребление по <b>'; print $up[2]; print '</b>: '; print $QPkor;
	 ...
	 if ($ui[2]=='7')	// электричество
		{
		 print '<hr><br><h2>Электричество</h2>';
	         // Для каждого объекта типа помещение или агрегат
		 $index=0; $QE=0;
		 ...
		 print 'Общее потребление электричества: '; print $QE;
		 //-------------------------------------------------------		 
		 ...
		 for ($c=1;$c<=100;$c++)
			{
			 ...
			 if ($up == true)
			     ...
			     for ($x=1;$x<=12000;$x++)
				{
			     ...
			     print '<br>Общее потребление по корпусу '; print $up[2]; print ': '; print $QEkor;
			     // Для каждого объекта типа помещение или агрегат, принадлежащих корпусу считаем коэффициент
			     $index=0;
